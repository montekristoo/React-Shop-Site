        ...
        <div className="flex flex-col xl:w-11/12 xl:h-[calc(100vh_-_81px)] w-auto h-min-[calc(100vh_-_81px)] justify-around relative">
          <div className="grid xl:grid-cols-3 relative">
            <div className="flex flex-col justify-evenly max-w-lg mx-auto">
              <div className="flex flex-col xl:items-start xl:p-0 p-10 font-serif transition duration-300 delay-75">
              ...
              <div className="flex flex-col xl:items-start xl:p-0 p-5 text-base font-normal transition ease-in-out duration-500 delay-250">
          ...
          <div className="flex flex-col justify-between w-12/12 h-auto">
            <div className="flex justify-center text-logo transition duration-300 delay-75">
